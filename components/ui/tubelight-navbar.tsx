...
import { LucideIcon, type Icon } from "lucide-react"
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "relative cursor-pointer text-sm font-semibold px-3 py-3 md:px-6 md:py-2 rounded-full transition-colors touch-manipulation",
